...
function set_background_image(hrs){
	...
	if(hrs>=6 && hrs<12){
		bg.style.background = 'url(../images/morning.png) no-repeat center center';
		bg.style.backgroundSize = 'cover';
		bg.style.backgroundAttachment = 'fixed';
		bg2.style.background = 'url(../images/morning.png) no-repeat center center';
		bg2.style.backgroundSize = 'cover';
		bg2.style.backgroundAttachment = 'fixed';
	}
	else if(hrs>=12 && hrs<19){
		bg.style.background = 'url(../images/afternoon.jpg) no-repeat center center';
		bg.style.backgroundSize = 'cover';
		bg.style.backgroundAttachment = 'fixed';
		bg2.style.background = 'url(../images/afternoon.jpg) no-repeat center center';
		bg2.style.backgroundSize = 'cover';
		bg2.style.backgroundAttachment = 'fixed';
	}
	else{
		bg.style.background = 'url(../images/evening.jpg) no-repeat center center';
		bg.style.backgroundSize = 'cover';
		bg.style.backgroundAttachment = 'fixed';
		bg2.style.background = 'url(../images/evening.jpg) no-repeat center center';
		bg2.style.backgroundSize = 'cover';
		bg2.style.backgroundAttachment = 'fixed';
	}
}
